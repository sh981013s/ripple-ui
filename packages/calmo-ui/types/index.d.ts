...
export type CalmoTone = "default" | "neutral" | "accent" | "success" | "warning" | "danger";
export type CalmoSize = "sm" | "md" | "lg";
export type CalmoRadius = "sm" | "md" | "lg" | "xl";
...
export declare const calmoThemePresets: CalmoTheme[];
export declare const defaultCalmoTheme: CalmoTheme;
export declare function buildCalmoThemeVars(theme?: CalmoThemeDefinition): React.CSSProperties;
